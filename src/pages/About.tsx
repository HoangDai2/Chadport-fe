...
import img from "../img/AIR+JORDAN+1+ZM+AIR+CMFT+2.jpg";
import img2 from "../img/W+AIR+JORDAN+1+LOW+SE.png";
import img3 from "../img/quyen.jpg";
import img4 from "../img/phong.jpg";
import img5 from "../img/dai.jpg";
import img6 from "../img/kien.jpg";
import img7 from "../img/hung.jpg";
    ...
    <>
      ...
      <div id="content" className="site-content" role="main">
        <div className="page-about-us">
                      ...
                      <div className="banner-wrapper banners">
                        <div className="banner-image">
                          <a href="shop-grid-left.html">
                            <img src={banner_about} alt="Banner Image" />
                          </a>
                        </div>
                      </div>
                    </div>
                              ...
                              <div className="info">
                                <div className="content">
                                  ...
                                  <div className="banner-image-description">
                                    We love creating furniture you want and will
                                    love for years to come. Our designs feature
                                    a fusion of unique styles that inspire us –
          ...
          <section className="section section-padding m-b-70">
            <div className="section-container">
              <div className="block block-feature no-border">
                <div className="block-widget-wrap">
                  <div className="row lg-m-lr">
                    <div className="col-lg-3 col-md-6 col-sm-6 md-b-30 lg-p-lr">
                      <div className="box">
                        <div className="box-icon">
                          <span>
                            <svg
                              xmlns="http://www.w3.org/2000/svg"
                              className="svg-icon plant"
                              x="0"
                              y="0"
                              viewBox="0 0 64 64"
                            >
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 md-b-30 lg-p-lr">
                      <div className="box">
                        ...
                        <div className="box-title-wrap">
                          <h3 className="box-title">Flexible Payment</h3>
                          <p className="box-description">
                    ...
                    <div className="col-lg-3 col-md-6 col-sm-6 md-b-30 lg-p-lr">
                      <div className="box">
                        ...
                        <div className="box-title-wrap">
                          <h3 className="box-title">14 Day Returns</h3>
                          <p className="box-description">
                            ...
                            <div className="banner-wrapper-infor">
                              <div className="info">
                                <div className="content">
                                    ...
                                    >
                                      <g>
                                        <g xmlns="http://www.w3.org/2000/svg">
                                          ...
                                          <g>
                                            <path
                                              d="m165 231.5c-.7 0-1.5-.2-2.1-.5l-34.4-18.2-34.4 18.2c-1.4.7-3.1.7-4.4-.1-1.4-.8-2.2-2.3-2.2-3.9v-38.8c0-1.9 1.6-3.5 3.5-3.5s3.5 1.6 3.5 3.5v34.6l34-18 34 18v-34.6c0-1.9 1.6-3.5 3.5-3.5s3.5 1.6 3.5 3.5v38.8c0 1.6-.8 3-2.2 3.9-.7.4-1.5.6-2.3.6z"
                                              fill=""
                                              data-original=""
                                            ></path>
                                          </g>
                                          <g>
                                            <path
                                              d="m127.3 122.8-21-21c-1.4-1.4-1.4-3.6 0-4.9 1.4-1.4 3.6-1.4 4.9 0l16 16 38-37.9c1.4-1.4 3.6-1.4 5 0s1.4 3.6 0 4.9z"
                                              fill=""
                                              data-original=""
                                            ></path>
                                          </g>
                                  ...
                                  <div className="banner-image-description">
                                    Rest easy. From choice materials and expert
                                    hands, to precision tools and tests, we
                        ...
                        <div className="item">
                          <div className="testimonial-item">
                            ...
                            <div className="testimonial-excerpt">
                              ” Wonderful communication and your company even
                              sent a generous amount of samples to me, making my
                          ...
                          <div className="testimonial-image image-position-top">
                            <div className="thumbnail">
                              <img width="62" height="62" src={img3} alt="" />
                            </div>
                    ...
                    <SwiperSlide>
                      <div className="testimonial-content">
                        <div className="item">
                          ...
                          <div className="testimonial-image image-position-top">
                            <div className="thumbnail">
                              <img width="62" height="62" src={img4} alt="" />
                            </div>
                            <div className="testimonial-info">
                              <h2 className="testimonial-customer-name">
                                Saitama One
                    ...
                    <SwiperSlide>
                      <div className="testimonial-content">
                        <div className="item">
                          ...
                          <div className="testimonial-image image-position-top">
                            <div className="thumbnail">
                              <img width="62" height="62" src={img5} alt="" />
                            </div>
                            <div className="testimonial-info">
                              <h2 className="testimonial-customer-name">
                                Sara Colinton
                    ...
                    <SwiperSlide>
                      <div className="testimonial-content">
                        <div className="item">
                          ...
                          <div className="testimonial-image image-position-top">
                            <div className="thumbnail">
                              <img width="62" height="62" src={img6} alt="" />
                            </div>
                            <div className="testimonial-info">
                              <h2 className="testimonial-customer-name">
                                Sara Colinton
                    ...
                    <SwiperSlide>
                      <div className="testimonial-content">
                        <div className="item">
                          ...
                          <div className="testimonial-image image-position-top">
                            <div className="thumbnail">
                              <img width="62" height="62" src={img7} alt="" />
                            </div>
                            <div className="testimonial-info">
                              <h2 className="testimonial-customer-name">
                                Sara Colinton
