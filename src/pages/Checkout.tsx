    ...
    <>
      <div>
        <div id="page" className="hfeed page-wrapper">
          <header
            id="site-header"
            className="site-header header-v1 absolute bg-white"
          >
                                    ...
                                    <li className="mini-cart-item">
                                      ...
                                      >
                                        <img
                                          width={330}
                                          height={330}
                                          src="media/product/AIR+JORDAN+1+MID+SE+2.png"
                                        />
                                      </a>
                                      <a
                                        href="shop-details.html"
                    ...
                    <tbody>
                      ...
                      <tr className="tr-description">
                        ...
                        <td>
                          ...
                          polyester.7.8 ounce fleece sweatshirt made with up to
                          5 percent polyester created from recycled plastic.
                        </td>
                      </tr>
