  ...
  const handleLoginSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      const user = users.find(
        (u: any) => (u.email === loginData.username || u.phonenumber === loginData.username) && u.password === loginData.password
      );
                          ...
                          <div className="form-login">
                            <form method="post" className="login" onSubmit={handleLoginSubmit}>
                              ...
                              <div className="username">
                                ...
                                <input type="text" className="input-text" name="username" onChange={handleLoginChange} />
                              </div>
                              <div className="password">
                                <label>
                                  Password <span className="required">*</span>
                                </label>
                                <input className="input-text" type="password" name="password" onChange={handleLoginChange} />
                              </div>
                              <div className="rememberme-lost">
                                <div className="remember-me">
                                  <input name="rememberMe" type="checkbox" value="forever" onChange={handleLoginChange} />
                          ...
                          <div className="form-register">
                            <form method="post" className="register" onSubmit={handleRegisterSubmit}>
                              ...
                              <div className="email">
                                ...
                                <input type="email" className="input-text" name="email" onChange={handleRegisterChange} />
                              </div>
                              <div className="password">
                                <label>
                                  Password <span className="required">*</span>
                                </label>
                                <input type="password" className="input-text" name="password" onChange={handleRegisterChange} />
                              </div>
