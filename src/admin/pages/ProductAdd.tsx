...
function ProductAdd() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();
    const stproductWithId = { ...product, id: `${Date.now()}` }; // Tạo ID chuỗi
    try {
      await instance.post("/products", stproductWithId);
  ...
  return (
    <div className="container mt-5">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="row mb-3">
          <label htmlFor="price_sale" className="col-md-4 col-form-label">
            Price Sale
          </label>
          <div className="col-md-8">
            <input
        ...
        <div className="row mb-3">
          <label htmlFor="quantity" className="col-md-4 col-form-label">
            Quantity
          </label>
          <div className="col-md-8">
            <input
        ...
        <div className="row mb-3">
          <label htmlFor="type" className="col-md-4 col-form-label">
            Type
          </label>
          <div className="col-md-8">
            <input
        ...
        <div className="row mb-3">
          <label htmlFor="image_product" className="col-md-4 col-form-label">
            Image URL
          </label>
          <div className="col-md-8">
            <input
        ...
        <div className="row mb-3">
          <label htmlFor="category" className="col-md-4 col-form-label">
            Category
          </label>
          <div className="col-md-8">
            <select
