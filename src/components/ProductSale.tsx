...
import imgsale from "../img/bannerspPega.png";
import imgsale2 from "../img/pegasusBanner.png";
type Props = {};
                          ...
                          <div className="banner-wrapper-infor">
                            <div className="info">
                              <div className="content">
                                ...
                                <div className="banner-image-description text-white">
                            ...
                            <div className="info">
                              <div className="content">
                                <a
                                  ...
                                  href="shop-grid-left.html"
                                >
                                  <h3 className="title-banner text-white">
                                    UP TO <span>20% OFF</span>
                                  </h3>
                                </a>
                                <div className="banner-image-description text-white">
                                  Don't miss savings for you...
                                </div>
                              </div>
                            </div>
                          </div>
